...
import { AlertCircle, ArrowRight, CheckCircle2, Eye, EyeOff, GraduationCap } from "lucide-react";
        ...
        <div className="flex min-h-[calc(100vh-4rem)] w-full items-center justify-center bg-[rgba(249,250,251,0.8)] p-3 sm:p-6">
            <div className="flex w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-[#e5e7eb] bg-white shadow-2xl lg:h-[calc(100vh-4rem-3rem)] lg:max-h-[680px] lg:flex-row lg:rounded-[28px]">
                <AuthLeftPanel
                    ...
                    description="Create your account and launch your learning journey. Join as a student and experience a polished learning workspace from day one."
                />
                ...
                <div className="flex w-full flex-1 items-center justify-center overflow-y-auto p-5 sm:p-7 lg:p-8">
                    <div className="w-full max-w-[400px]">
                        ...
                        <div className="pt-4">
                            <p className="text-[11px] font-bold uppercase leading-4 tracking-[1.2px] text-[#155dfc]">Register</p>
                            ...
                            <p className="mt-1 text-[12.5px] leading-5 text-[#6a7282]">
                                Create your account and launch your learning journey.
                            </p>
                        </div>
                        ...
                        <p className="mt-3.5 text-center text-[12.5px] text-[#6a7282]">
                            ...
                            <Link href="/login" className="font-semibold text-[#155dfc] transition hover:text-[#4f39f6]">
                                Sign in
                            </Link>
                        </p>

                        <p className="mx-auto mt-2 max-w-[400px] px-2 text-center text-[10.5px] leading-4 text-[#99a1af]">
                            Teacher and admin accounts are created by your institution&rsquo;s administrator.
                        </p>
                    </div>
                </div>
            </div>
